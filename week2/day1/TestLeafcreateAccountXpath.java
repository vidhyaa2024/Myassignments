...
public class TestLeafcreateAccountXpath {
	...
	public static void main(String[] args) 
	{
	  ...
	  driver.get("http://leaftaps.com/crmsfa/control/main?externalLoginKey=EL136448462093");
	  ...
	  driver.findElement(By.xpath("//input[@id='accountName']")).sendKeys("Vidhyajanakiraman1");
